...
sampleJSON = [{
	...
	{
		"Company-Name": "Datagne",
		"Position-Name": "Software Engineering Internship",
		"Qualifications": ["bachelors, masters", "Object Oriented Programming", "problem solving skills", "team work"]
	}
]
...
def jobDescriptionToDB(jobDescriptionsJSON):
    ...
    jobDescriptionDict = json.loads(jobDescriptionJSON)
    print jobDescriptionDict
